...
echo "To enable the framebuffer for Waveshare display, you may need to configure the boot config:"
echo ""
echo "For newer Raspberry Pi OS (Bookworm and later): /boot/firmware/config.txt"
echo "For older Raspberry Pi OS (Bullseye and earlier): /boot/config.txt"
echo ""
echo "For Waveshare 3.5\" LCD (B), add these lines:"
echo "  dtparam=spi=on"
